...
//  G3MiOSSDK
//
//  Created by G on 3/24/14.
//
//

#ifndef __G3MiOSSDK__ZWMSMarksLayer__
#define __G3MiOSSDK__ZWMSMarksLayer__
...
class ZWMSMarksLayer: public Layer {
private:
...
public:
    ...
    ZWMSMarksLayer(const std::string& mapLayer,
    ...
    ZWMSMarksLayer* copy() const;
    
    RenderState getRenderState();
};

#endif /* defined(__G3MiOSSDK__ZWMSMarksLayer__) */
