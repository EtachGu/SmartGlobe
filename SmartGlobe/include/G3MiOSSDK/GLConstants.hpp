...
public:
  ...
  static int clampToEdge() { return _clampToEdge; }
    static int TextureParameterValue_Repeat() {return _repeat;}
    static int TextureParameterValue_Mirrored_repeat() {return _mirroredRepeat;}
  ...
  static void init(const INativeGL* ngl) {
    ...
    _clampToEdge = ngl->TextureParameterValue_ClampToEdge();
      ...
      _mirroredRepeat = ngl->TextureParameterValue_Mirrored_repeat();
  }
};
