...
{
    [_tableView setFrame:CGRectMake(0, 0, frame.size.width, frame.size.height)];
...
- (void)tableViewCellTouchUpInside:(UITapGestureRecognizer *)gesture
{
    ...
    if(CGRectContainsPoint(rect,point))
    {
        ...
        {// 第一行
            SSCheckBoxView* view =(SSCheckBoxView*)cell.accessoryView;
            [view TapOnChechBox:point];
        }
        if (indexPath.section ==1)
        {// 第二行
            SSCheckBoxView* view =(SSCheckBoxView*)cell.accessoryView;
            [view TapOnChechBox:point];
            cell.backgroundColor = [UIColor colorWithRed:0 green:0 blue:1 alpha:0.8];
        }
        if (indexPath.section==2)
        {
...
//列表cell的ExpandView点击
- (void)tableViewExpandViewTouchUpInside:(UITapGestureRecognizer *)gesture
{
...
- (void)insertViewForExpandWithIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.viewForExpand.frame = CGRectMake(0, cellHeight,cell.bounds.size.width, openHeight);
    //cell.isOpen = YES;
   ...
   //    return ;
    ...
    else
    {
        ...
        else
        {
            ...
            if (self.selectOldIndexPath.section==-1)
            {
...
//                [updataIndexPathArray addObject:self.selectIndexPath];
            ...
            UITableViewCell* view = [self.tableView cellForRowAtIndexPath:self.selectOldIndexPath];
